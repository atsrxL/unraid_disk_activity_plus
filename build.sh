...
rm -f "$SRC"
chmod +x "$PLUGIN/bin/disk_wake_monitor" "$PLUGIN/scripts/rc.disk_activity" "$PLUGIN/scripts/disk_wake_tracker" "$PLUGIN/event/started/disk_activity_start" "$PLUGIN/event/stopping_svcs/disk_activity_stop"
